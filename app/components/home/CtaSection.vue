<template>
  <section class="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-gray-900 to-gray-800 text-white">
    <div class="container-custom text-center px-4 sm:px-0">
      <h2 class="font-heading font-medium text-2xl sm:text-3xl md:text-4xl lg:text-5xl mb-4 sm:mb-6">
        Let's Create Something
        <span class="text-transparent bg-clip-text bg-gradient-to-r from-pink-300 to-green-300 block sm:inline">
          Beautiful
        </span>
        Together
      </h2>
